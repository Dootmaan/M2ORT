...
class HER2Dataset(torch.utils.data.Dataset):
    def __init__(self, path='/newdata/why/HER2/',mode='train',selected_genes=None,patch_size=224):
        # selected_genes=top_gene_selection(path,2000)
        if selected_genes==None:
            selected_genes=np.load('HER2_Selected_Genes.npy',allow_pickle=True).tolist()
